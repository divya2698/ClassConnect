...
const Course = () => {
    ...
    React.useEffect(() => {
        Axios.get(`http://localhost:4000/api/quiz/course/${courseID}`)
            .then((res) => {
                if (res.data.success) {
    ...
    React.useEffect(() => {
        ...
        Axios.get(`http://localhost:4000/teacher/${teacher_id}`)
            .then((res) => {
                if (res.data.success) {
    ...
    React.useEffect(() => {
        Axios.get(`http://localhost:4000/api/course/students/${courseID}`)
            .then((res) => {
                if (res.data.success) {
    ...
    React.useEffect(() => {
        Axios.get(`http://localhost:4000/api/course/assignment/${courseID}`)
            .then((res) => {
                if (res.data.success) {
    ...
    React.useEffect(() => {
        ...
        Axios.get(`http://localhost:4000/api/messages/${loc[loc.length - 1]}`).then((res) => {
            if (res.data.success) {
    ...
    const generatePDF = (tickets) => {
        const doc = new jsPDF();
        const tableColumn = ["Name",  "Department", "Email"];
    ...
    const postMaterial = () => {
        ...
        Axios.post("http://localhost:4000/api/assignment", materialData)
            .then((res) => {
                var formData = new FormData();
                formData.append("file", attachment);
                Axios.post(
                    `http://localhost:4000/api/assignment/attachment/${res.data.data._id}`,
                    formData,
                    {
                        headers: {
                    ...
                    .then((res1) => {
                        if (isAssignment === true) {
                            ...
                            toast.success(
                                "New study material successfully created"
                            );
                        }
                    })
                    .catch((err) => {
                        if (isAssignment === false) {
                            ...
                            Axios.delete(`http://localhost:4000/api/assignment/${res.data.data._id}`)
                                .then(() => {
                                    console.log(
                                        "Assignment with invalid attachment deleted"
                                    );
                                })
                                .catch(() => {});
                        }
    ...
    const removeStudent = (student_id, course_id) => {
        Axios.post("http://localhost:4000/api/removeStudent", {
    ...
    const deleteCourse = (course_code, course_id) => {
        Axios.delete(`http://localhost:4000/api/course/${course_id}`)
            .then((res) => {
                if (res.data.success) {
    ...
    const changeCourseName = () => {
        ...
        const url = `http://localhost:4000/api/course/changeName/${courseID}`;
        Axios.post(url, {
            name: newCourseName,
        })
            .then((res) => {
    ...
    const sendMessage = () => {
        ...
        const obj = {
            user_id: user._id,
            user_name: user.firstname.concat(" ").concat(user.lastname),
            user_type: userType,
            message_content: message.trim(),
            time_stamp: new Date().getTime().toString(),
            course_id: loc[loc.length - 1],
        };
        Axios.post(`http://localhost:4000/api/message`, obj).then((res) => {
            if (res.data.success) {
            }
            Axios.get(
                `http://localhost:4000/api/messages/${loc[loc.length - 1]}`
            ).then((res) => {
                if (res.data.success) {
                    setMessages(res.data.data);
                }
            ...
            <div className="course-container">
                ...
                <div className="course-heading-block">
                    ...
                    >
                        ...
                        >
                            {courseStudents.length ? courseStudents.length : 0}{" "}
                            student(s) enrolled
                        </p>
                    </div>
                </div>
                        ...
                        >
                            {userType === "teacher" ? (
                                <React.Fragment>
                                    ...
                                    >
                                        Copy this code and share with the
                                        students. They can use this code to join
                                        this course.
                                    </p>
                                </React.Fragment>
                            ) : null}
                ...
                >
                    ...
                    >
                        ...
                        <div style={{ marginLeft: "1rem" }}>
                            ...
                            >
                                Create new study material or quiz
                            </p>
                        </div>
                    </div>
                    ...
                    {isQuiz ? (
                        ...
                        >
                            <li>
                                ...
                                >
                                    Quiz can be started at any time post
                                    creation
                                </p>
                            </li>
                            <li>
                                ...
                                >
                                    Quiz can have two types of questions,
                                    multiple choice questions (MCQ) or textual
                                    questions
                                </p>
                            </li>
                            <li>
                                ...
                                >
                                    For textual or theoretical questions,
                                    provide some keywords based upon which the
                                    student responses will be autograded
                                </p>
                            </li>
                            <li>
                                <p
                                ...
                                >
                                    Each MCQ carries one mark while the marks
                                    for textual questions have to be specified
                                </p>
                            </li>
                        </ul>
                    ) : null}
