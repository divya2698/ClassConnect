...
const CreateCourse = (props) => {
  ...
  const createCourse = () => {
    ...
    Axios.post("http://localhost:4000/api/course", courseObject, {
      header: {
  ...
  const joinCourse = () => {
    ...
    Axios.post("http://localhost:4000/api/checkCourse", codeObject, {
      header: {
        "Content-Type": "application/json; charset=utf-8",
      },
    })
      .then((res) => {
        if (res.data.success) {
          ...
          Axios.post('http://localhost:4000/api/records', recordObject,  
            {header: {
              "Content-Type": "application/json; charset=utf-8",
            },})
            .then((res) => {
